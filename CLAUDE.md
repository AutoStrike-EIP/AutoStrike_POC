...
|-----------|------------|
| **Server** | Go 1.24+, Gin, SQLite, gorilla/websocket |
...
296 techniques ship with the project after running `make import-mitre` (48 built-in + 248 imported from MITRE ATT&CK STIX + Atomic Red Team, 1791 executors across 13 YAML files).

| Tactic | Total | Built-in IDs |
|--------|-------|--------------|
| Reconnaissance | 2 | T1592.004, T1595.002 |
| Initial Access | 4 | T1078, T1133, T1190 |
| Execution | 22 | T1059.001, T1059.003, T1059.004, T1047, T1059.006 |
| Persistence | 44 | T1053.005, T1547.001, T1053.003, T1543.002 |
| Privilege Escalation | 18 | T1548.001, T1548.002, T1078.003, T1134.001 |
| Defense Evasion | 89 | T1070.004, T1562.001, T1027, T1070.001, T1036.005, T1218.011 |
| Credential Access | 34 | T1552.001, T1555.003, T1003.008, T1552.004 |
| Discovery | 30 | T1082, T1083, T1057, T1016, T1049, T1087, T1069, T1018, T1007 |
| Lateral Movement | 8 | T1021.001, T1021.002, T1021.004 |
| Collection | 16 | T1005, T1039, T1074.001, T1119 |
| Command and Control | 13 | T1071.001, T1105, T1572 |
| Exfiltration | 8 | T1048.003, T1041, T1567.002 |
| Impact | 8 | T1490, T1489, T1486 |

All 48 built-in techniques are **safe mode compatible** (non-destructive). After import: 220 safe, 74 unsafe. Safety is determined **per-executor** based on: `!elevation_required && !hasDangerousPattern(command) && !hasDangerousPattern(cleanup)`. Use `make import-mitre-safe` to import only safe techniques.
...
| `is_safe` | bool | Per-executor safety (auto-computed: !elevation && no dangerous patterns) |
